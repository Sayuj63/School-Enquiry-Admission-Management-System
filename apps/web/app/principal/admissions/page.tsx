...
export default function PrincipalAdmissionsPage() {
    ...
    // For Principals, default to 'submitted' if no status is specified
    const [statusFilter, setStatusFilter] = useState(statusParam || 'submitted')
    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h2 className="text-2xl font-bold text-gray-900">Admissions Approval</h2>
                    <p className="text-gray-600">Review and decide on student admission applications</p>
                </div>
            </div>
            ...
            {/* Table */}
            <div className="card overflow-hidden p-0 shadow-lg border-none bg-white">
                {loading ? (
                                ...
                                {admissions.map((admission) => (
                                    <tr key={admission._id} className="hover:bg-gray-50 transition-colors">
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <Link
                                                href={`/principal/admissions/${admission._id}`}
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className={`px-2 py-1 text-[10px] font-black uppercase rounded-lg border ${statusColors[admission.status]}`}>
                    ...
                    <div className="px-6 py-3 flex items-center justify-between border-t border-gray-200 bg-gray-50">
                        ...
                        <div className="flex gap-2">
                            <button
                                ...
                                disabled={page === 1}
                                className="btn-secondary disabled:opacity-50 h-8 w-8 flex items-center justify-center p-0"
                            >
